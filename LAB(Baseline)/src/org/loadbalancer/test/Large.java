...
import org.loadbalancer.Coordinates;
import org.loadbalancer.FogNode;
import org.loadbalancer.IoTDevice;
...
public class Large {
    ...
    static ArrayList<FogNode> generateFogNodes() {
    ...
    static ArrayList<FogNode> fogNodes = generateFogNodes();
    static ArrayList<IoTDevice> iotDevices = generateIoTDevices();
    static org.loadbalancer.LoadBalancer lb = new org.loadbalancer.LoadBalancer(fogNodes, iotDevices);
    ...
    public static void main(String[] args) {
        ...
        Log.printLine("Starting iFogSim...");
        ...
        try {
            ...
            Log.printLine("iFogSim finished!");
        } catch (Exception e) {
            e.printStackTrace();
